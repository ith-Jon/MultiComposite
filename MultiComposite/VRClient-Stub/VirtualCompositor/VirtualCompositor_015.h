...
public:
	...
	* Returns 0 when fading out from an app and the app's process Id when fading into an app. */
	...
	virtual EVRCompositorError RequestScreenshot(EVRScreenshotType type, const char* pchDestinationFileName, const char* pchVRDestinationFileName) = 0;
	virtual EVRScreenshotType GetCurrentScreenshotType() = 0;
...
/** Allows the application to interact with the compositor */
class VirtualCompositor_015 : public VirtualCommon, public IVRCompositor_015
{
public:
	void* GetFnTable();
	...
	* Returns 0 when fading out from an app and the app's process Id when fading into an app. */
	 ...
	 *  a future update.  Use the functions via the
	 *  IVRScreenshots interface */
	EVRCompositorError RequestScreenshot(EVRScreenshotType type, const char* pchDestinationFileName, const char* pchVRDestinationFileName);
	EVRScreenshotType GetCurrentScreenshotType();
