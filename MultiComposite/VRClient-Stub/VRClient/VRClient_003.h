...
class IVRClientCore_003
{
public:
	/** Initializes the system */
	virtual vr::EVRInitError Init(vr::EVRApplicationType eApplicationType, const char* pStartupInfo) = 0;
...
class VRClient_003 : public IVRClientCore_003
{
public:
	/** Initializes the system */
